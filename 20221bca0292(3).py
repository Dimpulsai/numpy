# -*- coding: utf-8 -*-
"""20221BCA0292(3).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UJSf_bgwiv3H9xOrb4Uo1cIADeLw83Qh
...
print(list(itertools.repeat(200, 4)))
...
print(list(product(['BCOM', 'CSE', 'ECE'], '2')))
print()
...
print(list(permutations([1, 'ComputerScience'], 2)))
print()
...
print(list(permutations(range(1), 2)))
...
print(list(itertools.compress('UTTARADHIDIMPULSAI', [
...
print(*(itertools.zip_longest('desgt', 'sandy', fillvalue='_')))
