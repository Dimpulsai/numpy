# -*- coding: utf-8 -*-
"""20221BCA0292 (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UPjpkThXHq65YIh538Ohme-_8PAscBtG
...
list(map(upper, ['dimpul', 'uttaradhi']))

[upper(s) for s in ['dimpul', 'uttaradhi']]
...
rand_list = random.sample(range(10000), 5)
rand_list
